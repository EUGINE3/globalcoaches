...
class StudentEnrollmentAdmin(admin.ModelAdmin):
    list_display = ('student', 'program_level', 'status', 'enrollment_date', 'get_progress')
    list_filter = ('status', 'program_level', 'enrollment_date')
    search_fields = ('student__username', 'student__first_name', 'student__last_name')
    readonly_fields = ('enrollment_date',)
    raw_id_fields = ('student', 'program_level')
...
class StudentReflectionAdmin(admin.ModelAdmin):
    ...
    list_filter = ('is_private', 'enrollment__program_level', 'created_at')
...
class FinalProjectAdmin(admin.ModelAdmin):
    ...
    list_filter = ('approved', 'enrollment__program_level', 'submitted_at', 'defense_date')
